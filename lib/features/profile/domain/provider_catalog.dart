...
class LlmProviderCatalog {
  ...
  static const List<ProviderDef> all = [
    ...
    ProviderDef(
      ...
      displayName: 'Volcengine Doubao (火山豆包)',
...
class SttProviderCatalog {
  ...
  static const List<ProviderDef> all = [
    ...
    ProviderDef(
      id: 'volcengine_stt',
      displayName: 'Volcengine STT (火山语音识别)',
      kind: ProviderKind.vendor,
    ...
    ProviderDef(
      id: 'tencent_stt',
      displayName: 'Tencent Cloud STT (腾讯云语音识别)',
      kind: ProviderKind.vendor,
...
class TtsProviderCatalog {
  ...
  static const List<ProviderDef> all = [
    ...
    ProviderDef(
      id: 'volcengine_tts',
      displayName: 'Volcengine TTS (火山语音合成)',
      kind: ProviderKind.vendor,
      defaultBaseUrl: 'https://openspeech.bytedance.com',
      defaultVoice: 'zh_female_shaoergu',
      docsUrl: 'https://www.volcengine.com/docs/6565',
      voices: [
        'zh_female_shaoergu',
    ...
    ProviderDef(
      id: 'tencent_tts',
      displayName: 'Tencent Cloud TTS (腾讯云语音合成)',
      kind: ProviderKind.vendor,
