...
class TutorRepository {
  static const List<Tutor> tutors = [
    Tutor(
      ...
      style: 'friendly',
      description: 'A friendly and supportive teacher who makes learning fun and comfortable.',
    ...
    Tutor(
      ...
      style: 'professional',
      description: 'A professional tutor focused on business English and formal communication.',
      systemPrompt: '''You are James, a professional English tutor specializing in business communication. You are structured, organized, and focused on practical skills. You provide clear explanations and real-world examples. Your corrections are precise and you focus on professional vocabulary and formal language patterns.''',
    ),
    Tutor(
      id: 'casual_friend',
      name: 'Alex',
      ...
      style: 'casual',
      description: 'A casual conversation partner who speaks like a native friend.',
    ...
    Tutor(
      ...
      style: 'strict',
      description: 'A strict coach who pays attention to every detail and pushes for excellence.',
    ...
    Tutor(
      ...
      style: 'exam',
      description: 'Specialized in IELTS/TOEFL preparation with exam strategies.',
    ...
    Tutor(
      ...
      style: 'pronunciation',
      description: 'A pronunciation expert who helps perfect your accent and intonation.',
